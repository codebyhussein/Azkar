...
class ScreensData extends StatefulWidget {
  ScreensData(
  ...
  @override
  State<ScreensData> createState() => _ScreensDataState();
}

class _ScreensDataState extends State<ScreensData> {
  @override
      ...
      body:  FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            final List showdata = json.decode(snapshot.data!);
            return ListView.separated(
                itemBuilder: (BuildContext context, int index) {
                  int count = showdata[index]['count'];
                  return listView(
